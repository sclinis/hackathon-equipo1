...
El diferencial está en **cruzar aceleración temporal con benchmarks de cierres reales**. Un aviso con 10 consultas recibidas en 1 día obtiene un Hot Score de **94 🔥**, mientras que uno con 50 consultas acumuladas en 90 días queda en **75 🌡️** — a pesar de tener 5 veces más consultas en términos absolutos. El volumen sin contexto temporal es una métrica ciega; el ritmo es lo que predice el cierre.
...
│                                                                 │
│  Fórmula del Hot Score:                                         │
│                                                                 │
│  score = (                                                      │
│    ritmo_consultas    × 0.30  ← consultas/día vs benchmark      │
│  + volumen_consultas  × 0.25  ← total consultas vs benchmark    │
│  + progreso_visitas   × 0.25  ← visitas Tokko vs benchmark      │
│  + frecuencia_semanal × 0.20  ← consultas/semana vs benchmark   │
│  ) × factor_tiempo × 100                                        │
│                                                                 │
│  factor_tiempo = 1.0  si días publicado ≤ 130% del benchmark   │
│                 decae hasta 0.35 si lleva demasiado tiempo      │
└────────────────────────┬────────────────────────────────────────┘
                         │
           ┌─────────────┴──────────────┐
           ▼                            ▼
